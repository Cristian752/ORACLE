-- Arlex David Saavedra G. 230171022
-- Cristian Fernando Toro B. 230171018

-- Punto 1)
-- Este punto se debe ejecutar con el usuario XE (SYSDBA)
-- Para el esquema del anexo cree en un usuario llamado "airbnb". Si existe se debe de eliminar,
-- luego hacer la creación y privilegios, y consignarlos en un script .sql particular para tal propósito. 
...
-- Desde el punto dos en adelante se ejecuta con el usuario creado anteriormente (AIRBNB)


-- Punto 2)
-- Crear la base de datos correspondiente al schema relacional del anexo.
...
INSERT ALL
    INTO USER1        (U_ID, U_UPDATED_AT, U_CREATED_AT, U_EMAIL, U_PASSWORD, U_FIRST_NAME, U_LAST_NAME ) VALUES ('1', TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'), 'STRI@HOTMAIL.COM', '1234', 'PAYASO', 'CROSTY')
INTO USER1        (U_ID, U_UPDATED_AT, U_CREATED_AT, U_EMAIL, U_PASSWORD, U_FIRST_NAME, U_LAST_NAME ) VALUES ('2', TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'), 'VINO@HOTMAIL.COM', '1234', 'BART', 'SIMPSON')
INTO USER1        (U_ID, U_UPDATED_AT, U_CREATED_AT, U_EMAIL, U_PASSWORD, U_FIRST_NAME, U_LAST_NAME ) VALUES ('3', TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'), 'CLAI@HOTMAIL.COM', '1234', 'LISA', 'SIMPSON')
INTO STATE        (S_ID, S_UPDATED_AT, S_CREATED_AT, S_NAME_)                                          VALUES ('1',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'VALLE')
INTO STATE        (S_ID, S_UPDATED_AT, S_CREATED_AT, S_NAME_)                                          VALUES ('2',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'ANTIOQUIA')
INTO STATE        (S_ID, S_UPDATED_AT, S_CREATED_AT, S_NAME_)                                          VALUES ('3',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'CALDAS')
INTO CITY         (C_ID, C_UPDATED_AT, C_CREATED_AT, S_STATE_ID, C_NAME)                               VALUES('1',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'1','TULUA')
INTO CITY         (C_ID, C_UPDATED_AT, C_CREATED_AT, S_STATE_ID, C_NAME)                               VALUES('2',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'2','MEDELLIN')
INTO CITY         (C_ID, C_UPDATED_AT, C_CREATED_AT, S_STATE_ID, C_NAME)                               VALUES('3',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'3','MANIZALES')
...
INTO PLACE        (P_ID, P_UPDATED_AT, P_CREATED_AT, P_U_ID, P_C_ID, P_DESCRIPTION, P_NUMBER_ROOMS, P_NUMBER_BATHROOMS, P_MAX_GUEST, P_PRICE_BY_NIGHT, P_LATITUDE, P_LONGITUDE, P_NAME) VALUES('1',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'1','1','HOLA',1,1,1,1,3.42, -76.52,'PARQUE')
INTO PLACE        (P_ID, P_UPDATED_AT, P_CREATED_AT, P_U_ID, P_C_ID, P_DESCRIPTION, P_NUMBER_ROOMS, P_NUMBER_BATHROOMS, P_MAX_GUEST, P_PRICE_BY_NIGHT, P_LATITUDE, P_LONGITUDE, P_NAME) VALUES('2',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'2','2','HOLA',1,1,1,1,3.42, -76.52,'CINE')
INTO PLACE        (P_ID, P_UPDATED_AT, P_CREATED_AT, P_U_ID, P_C_ID, P_DESCRIPTION, P_NUMBER_ROOMS, P_NUMBER_BATHROOMS, P_MAX_GUEST, P_PRICE_BY_NIGHT, P_LATITUDE, P_LONGITUDE, P_NAME) VALUES('3',TO_DATE(SYSDATE,'DD/MM/YYYY'), TO_DATE(SYSDATE,'DD/MM/YYYY'),'3','3','HOLA',1,1,1,1,3.42, -76.52,'RIO')
...
--CREAR SYNONYM
CREATE SYNONYM CITYS FOR AIRBNB.CITY;
CREATE SYNONYM STATES FOR AIRBNB.STATE;
CREATE SYNONYM USER1S FOR AIRBNB.USER1;
CREATE SYNONYM PLACEAMENITYS FOR AIRBNB.PLACEAMENITY;
CREATE SYNONYM REVIEWS FOR AIRBNB.REVIEW;
CREATE SYNONYM AMENITYS FOR AIRBNB.AMENITY;
CREATE SYNONYM PLACES FOR AIRBNB.PLACE;
CREATE SYNONYM V_REVIEW_USER_PLACES FOR AIRBNB.V_REVIEW_USER_PLACE;
CREATE SYNONYM V_PLACE_CITY_STATES FOR AIRBNB.V_PLACE_CITY_STATE;
CREATE SYNONYM V_PLACE_AMENITY_OTRAS FOR AIRBNB.V_PLACE_AMENITY_OTRA;



-- Punto 6)
-- Se necesita una consulta de jerarquía (Arbol).
...
INTO SITIOS (ID_SITIO, NAME_SITIO, ID_SITIO_HIJO) VALUES('3','BUGA','2')
INTO SITIOS (ID_SITIO, NAME_SITIO, ID_SITIO_HIJO) VALUES('4','ANDALUCIA','2')
INTO SITIOS (ID_SITIO, NAME_SITIO, ID_SITIO_HIJO) VALUES('5','ANTIOQUIA','1')
INTO SITIOS (ID_SITIO, NAME_SITIO, ID_SITIO_HIJO) VALUES('6','MEDELLIN','5')
SELECT * FROM DUAL;
...
-- Punto 7)
-- Presente una consulta que permita evaluar un join entre tablas y que en las tuplas a presentar
-- haya datos de ambas tablas que participan en el join agregando funciones de agrupación y de
-- filtrado de los datos agrupados. Regístrelo en archivo .sql.
...
-- Punto 8)
-- Presente una consulta que tenga filtrado de datos usando operaciones IN o ANY o ALL con
-- subquery. Registre la consulta en script SQL 
...
-- Punto 9)
-- Realice una consulta que presente los datos de forma matricial en donde las columnas presenten
-- información de tiempo (años, meses o días), y en las filas usuarios. Entregue la consulta en script SQL
